...
$('.linebox-interedit').on('click','.btn-com',function(){
	...
	appendHtml += ("<div class='line-interedit line-com'>"
				...
				+"<select name='"+paramName+"["+appendIndex+"].paramType' id='' style='width:10%'>"
				+"<option value='string'>string</option>"
				+"<option value='int'>int</option>"
				+"</select>"
				+"<textarea name='"+paramName+"["+appendIndex+"].exampleData' id='' value='' placeholder='参数示例' style='width:30%'></textarea>"
				+"<textarea name='"+paramName+"["+appendIndex+"].description' id='' value='' placeholder='备注' style='width:15%'></textarea>"
