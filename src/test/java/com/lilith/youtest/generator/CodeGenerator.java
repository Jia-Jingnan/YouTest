package com.lilith.youtest.generator;
...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/youtest?characterEncoding=UTF8&autoReconnect=true&serverTimezone=Asia/Shanghai&allowMultiQueries=true");
        ...
        pc.setParent("com.lilith.youtest");
        ...
        strategy.setInclude("api_request_param");
